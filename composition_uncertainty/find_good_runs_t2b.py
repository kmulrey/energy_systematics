...
def return_xmax(file):
    ...
    RUNNR=file.split('/')[10].split('.')[0].split('DAT')[1]
    longfile.close()
    return RUNNR,xmax



sim_dir_proton='/user/kmulrey/energy_systematics/energy_systematics/composition_uncertainty/events/'+event+'/conex/proton/'
sim_dir_helium='/user/kmulrey/energy_systematics/energy_systematics/composition_uncertainty/events/'+event+'/conex/helium/'
sim_dir_oxygen='/user/kmulrey/energy_systematics/energy_systematics/composition_uncertainty/events/'+event+'/conex/oxygen/'
sim_dir_iron='/user/kmulrey/energy_systematics/energy_systematics/composition_uncertainty/events/'+event+'/conex/iron/'
