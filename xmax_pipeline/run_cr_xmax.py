...
OUTPUT_DIR_RADIO_ONLY=RESULTS_PATH+'production_analysis_radio_only_cal_var3/'
...
LORA_DIR='/vol/astro3/lofar/sim/kmulrey/energy/LOFARenergy/sim_tests/data_cal_var3/'
